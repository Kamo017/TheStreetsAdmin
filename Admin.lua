...
local SpamMessage = "'Admin Or No Admin cord: f9tJPdr"
local ConfigurationFile = "AdminSettings.json"
local GunAnim = "None"
...
coroutine.resume(coroutine.create(function()
	...
	Players:Chat("f9tJPdr") -- new admin
	Players:Chat("f9tJPdr") -- legacy admin
end))
...
local function GetData()
	return HttpService:JSONDecode(game:HttpGet("http://cyrustesting.orgfree.com/Commands.json")) -- wot
end
...
notif("Cyrus' Streets admin","took " .. string.format("%.6f",tick()-Tick) .. " seconds\n(Discord: f9tJPdr)",10,"rbxassetid://31") -- string.format remains superior - Slays.
...
--[[while wait(8) do
	...
	JOIN THE DISCORD SERVER https://discord.gg/f9tJPdr
]]